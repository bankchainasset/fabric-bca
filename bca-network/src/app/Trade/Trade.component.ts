...
export class TradeComponent implements OnInit {
  ...
  busasset = new FormControl('', Validators.required);
  ...
  addTransaction(form: any): Promise<any> {
    this.Transaction = {
      $class: 'org.bca.bcanetwork.Trade',
      'busasset': this.busasset.value,
  ...
  getForm(id: any): Promise<any> {
    ...
    .then((result) => {
      ...
      if (result.busasset) {
        formObject.busasset = result.busasset;
      } else {
        formObject.busasset = null;
      }
